...
symptoms = [
    ...
    'passage_of_gases', 'internal_itching', 'toxiclook(typhos)', 'depression', 'irritability',
...
# Button to redirect
if st.button('Maps'):
    # Redirect to the HTML page (this will open in a new tab)
    st.write('[Click here to proceed](http://127.0.0.1:5000/maps)')
